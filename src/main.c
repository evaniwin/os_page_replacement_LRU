...
int lru_page_replacement(uint8_t *page_refrence, unsigned int page_refrence_len, uint8_t no_of_frames, uint8_t **pagefaults);
...
int test_lru(void)
{
	...
	lru_page_replacement(page_refrence, page_refrence_len, no_of_frames, &pagefaults);
...
int lru_page_replacement(uint8_t *page_refrence, unsigned int page_refrence_len, uint8_t no_of_frames, uint8_t **pagefaults)
{
	uint16_t *frame_history = (uint16_t *)malloc(sizeof(uint16_t) * page_refrence_len * no_of_frames);
